...
void verifyCommandLineArguments(char filename[], unsigned short *secretKey, int *blockSize)
{
...
void constructClientRequest(unsigned char clientRequest[], unsigned short *secretKey, char *fileName)
{
...
int main(int argc, char **argv) 
{
    ...
    constructClientRequest(clientRequest, &secretKey, fileName);
    ...
    while(attempts++ < 5)
    {
        ...
        sendto(sockfd, (const char*)clientRequest,10,0,(const struct sockaddr *) &servAddr, addLen);
        fflush(stdout);
